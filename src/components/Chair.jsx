...
export function Chair(props) {
  ...
  const { copyTextures } = useCustomization();
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Mesh05.geometry} material={copyTextures ? materials['Material.010'] : materials['Material.005']} position={[0, 0, -6]} />
      ...
      <mesh geometry={nodes.Mesh02.geometry} material={copyTextures ? materials['Material.007'] : materials['Material.002']} position={[0, 0, 3.113]} />
